                            ...
                            <div className='col-sm-12 col-lg-6 border-right'>
                                <div className='row'>
                                    <div className='col-2 mt-4'>
                                        <img src="https://t3.ftcdn.net/jpg/03/46/83/96/360_F_346839683_6nAPzbhpSkIpb8pmAwufkC7c5eD7wYws.jpg" width="120px" height="120px"></img>
                            ...
                            <div className='col-sm-12 col-lg-6 d-flex align-self-center '>
                                <table class="table table-borderless table-condensed table-hover">
                                    <tr>
                                        ...
                                        <td><h4 className='ml-2'>112 Ton Duc Thang Ho Chi Minh city</h4></td>
                                    </tr>
                                    <tr>
